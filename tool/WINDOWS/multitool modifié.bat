...
echo 2: +Manipulation libre
echo 3: Quitter
choice /C:12345 /M "Faites votre choix:"
if errorlevel 5 goto start
if errorlevel 4 goto sound
if errorlevel 3 goto soff
...
if errorlevel 2 goto rootMAN
if errorlevel 1 goto rootEVO
...
:rootMAN
if exist .\Data\zerg.txt goto done
...
echo test sur MMC0
%adb% shell cat /sys/class/mmc_host/mmc0/mmc0:*/cid >> .\MMC\MMC.txt
echo Ton MMC est le:
...
choice /t:10 /C:12 /M "Faites votre choix:" /D 1
