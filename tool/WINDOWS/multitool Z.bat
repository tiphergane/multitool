...
echo		5: Passage sur le VISION PVT ENG S-OFF (Permroot OBLIGATOIRE)
...
echo 3: Update
echo 4: Quitter
choice /C:1234567890 /M "Faites votre choix:"
...
:clock
echo recuperation du recovery clockwork 2.5.0.7 pour le HTC (%ver%)
...
echo.
echo ********************************************************************************
echo             		HTD VISION (%ver%) VISION PVT ENG S-OFF
echo ********************************************************************************
echo.
...
echo oui (1) non (2)
choice /C:12 /M "Faites votre choix DERNIERE BOUCLE SANS DANGER:"
if errorlevel 2 goto error
...
echo oui (1) non (2)
choice /C:12 /M "Faites votre choix:"
if errorlevel 2 goto greetz
if errorlevel 1 goto oups
