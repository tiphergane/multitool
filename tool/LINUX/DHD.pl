...
print "	4: +Installer Visionary ou GingerBreak\n";
...
print "	5: Gerer la SD via Windows\n";
print "	6: -Downgrade 1.7x vers 1.31.405.3\n";
print "		1: Downgrade Froyo\n";
print "		2: Downgrade Ginger 2.3.x\n";
print "		3: Downgrade Ginger 2.37\n";
...
clock:
print "recuperation du recovery clockwork 3.0.0.6 pour le HTC ($ver)\n";
$url = "http://mirror.kanged.net/recoveries/recovery-clockwork-3.0.0.6-ace.img";
system("wget $url");
...
adb:
print "recuperation du recovery AmonRA pour le HTC ($ver)\n";
$url = "http://xdafil.es/DesireHD/Recovery%20Images/adb_recovery.img";
print "passage en fastboot\n";
system("$adb reboot bootloader");
print "flash du recovery\n";
system("$fb flash recovery adb_*.img");
print "reboot du GSM\n";
system("$fb reboot");
unlink glob "*.img";
goto greetz;
...
print "	3: Forcer l'installation sur la SDCARD ROM Froyo\n";
print "	4: -Installer Visionary ou GingerBreak\n";
print "		1: Installer Visionary\n";
print "		2: Installer GingerBreak\n";
print "		3: retour au menu prevedent\n";
print "	5: Gerer la SD via Windows\n";
print "	6: +Downgrade 1.7x vers 1.31.405.3\n";
print "	7: Verification des secu_flags\n";
print "	8: Retour au menu precedent\n";
...
system("clear");
print "*" x 80;
print "            					GingerBreak install\n";
print "*" x 80;
$vi='./Data/GingerBreak*.apk';
print "Installation de GingerBreak\n";
system("$adb install -l $vi");
print "DONE !!!!\n";
sleep 5;
goto greetz;
...
system("clear");
print "*" x 80;
print "            					HTD ACE ($ver) Downgrade\n";
print "http://forum.xda-developers.com/showthread.php?t=905003\n";
print "*" x 80;
# echo.
$ps='./Data/psneuter';
...
$ps='./Data/fre3vo';
$misc='./Data/misc_version';
$break='./Data/GingerBreak';
# REM envoie des fichier necéssaire au downgrade sur /data/local/tmp
system("$adb push $ps /data/local/tmp");
system("$adb push $misc /data/local/tmp");
system("$adb push $break /data/local/tmp");
system("$adb shell chmod 777 /data/local/tmp/fre3vo");
system("$adb shell chmod 777 /data/local/tmp/misc_version");
system("$adb shell chmod 777 /data/local/tmp/GingerBreak");
system("$adb shell ./data/local/tmp/fre3vo -debug -start FAA90000 -end FFFFFFFF");
system("$adb wait-for-device");
system("$adb shell /data/local/tmp/misc_version -s 1.31.405.6");
print "nice done\n";
sleep 5;
...
print "*" x 80;
# REM Flash du hboot en ACE PVT ENG S-OFF
print "Flash du hboot en ACE PVT ENG S-OFF, attention la manipulation avec attentions\n";
