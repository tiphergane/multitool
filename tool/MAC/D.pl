...
print "Test sur MMC1\n";
system("$adb shell cat /sys/class/mmc_host/mmc1/mmc1:*/cid >> ./MMC/MMC1.txt");
print "test sur MMC0\n";
system("$adb shell cat /sys/class/mmc_host/mmc0/mmc0:*/cid > ./MMC/MMC0.txt");
print "ton CID est:\n";
